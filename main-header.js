...
(function () {
  ...
  var HEADER_HTML = [
    ...
    '        <span class="subtitle">GPT/Claude/Gemini 充值</span>',
    '      </div>',
    '    </a>',
    ...
    '          <li><a href="purchase-gpt.html" class="nav-highlight" data-nav="gpt"><i class="fa-solid fa-book-open"></i> 可代充GPT Go/Pro(5x/20x)/Codex</a></li>',
    '          <li><a href="purchase-claude.html" class="nav-highlight" data-nav="claude"><i class="fa-solid fa-right-to-bracket"></i> 可代充Claude Max</a></li>',
    '          <li><a href="purchase-gemini.html" class="nav-highlight" data-nav="gemini"><i class="fa-solid fa-star"></i> 可代充Gemini</a></li>',
    '          <li><a href="purchase-grok.html" class="nav-highlight" data-nav="grok"><i class="fa-solid fa-bolt"></i> 可代充Grok等</a></li>',
    '          <li><a href="purchase-premium.html" class="nav-highlight" data-nav="premium"><i class="fa-solid fa-crown"></i> 可代充X-Premium(+)</a></li>',
